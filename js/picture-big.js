 ...
 *
 * @param {object} post — объект с данными фотографии и комментариев.
 */

const renderPictureModal = (post) => {

  const totalCommentList = post.comments.slice();
  const totalCommentListLength = totalCommentList.length;
